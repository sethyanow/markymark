...
Quick-reference tables for language constructs, compiler errors, and Cargo configuration.
These are look-up files, not tutorial material.

### Files

| File | Purpose | When to Look Up |
|------|---------|----------------|
...
These files are for lookup, not reading start-to-finish. Search for the specific
error code, syntax construct, rule, or Cargo field you need.
