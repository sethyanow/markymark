...
async fn setup_workspace() -> (ServerState, DocumentUri, DocumentUri) {
...
#[tokio::test]
async fn test_resolve_wiki_link_to_document() {
    let (state, uri_main, uri_other) = setup_workspace().await;
...
#[tokio::test]
async fn test_resolve_wiki_link_to_heading_in_other_doc() {
    let (state, uri_main, uri_other) = setup_workspace().await;
...
#[tokio::test]
async fn test_resolve_wiki_link_same_page_heading() {
    let (state, uri_main, _uri_other) = setup_workspace().await;
...
#[tokio::test]
async fn test_resolve_markdown_link_same_page_anchor() {
    let (state, uri_main, _uri_other) = setup_workspace().await;
...
#[tokio::test]
async fn test_resolve_wiki_link_not_found() {
    let (state, uri_main, _) = setup_workspace().await;
...
#[tokio::test]
async fn test_references_heading_found_by_wiki_links() {
...
#[tokio::test]
async fn test_hover_heading_returns_info() {
...
#[tokio::test]
async fn test_document_symbols_returns_heading_hierarchy() {
