...
type: epic
priority: 2
depends_on: [marky-lpb, marky-f1w, marky-v60, marky-enr]
parent: marky-zsys
---
...
- [x] LSP `apply_document_changes` computes cumulative edit byte bounds and passes to engine
- [x] Test: LSP threads incremental change ranges to engine update
