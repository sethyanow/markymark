...
#[tokio::test]
async fn test_acceptance_completion_updates_after_document_change() {
    ...
    state
        .open_document(uri_target.clone(), "# Original Heading\n".to_string())
        .await;
    state
...
#[tokio::test]
async fn test_acceptance_wiki_link_completion_excludes_current_document() {
    ...
    state
        .open_document(uri_a.clone(), "# Alpha\n\nLink: [[".to_string())
        .await;
...
#[tokio::test]
async fn test_acceptance_tag_not_triggered_inside_wiki_link() {
    ...
    state
        .open_document(uri.clone(), "See [[Page#heading".to_string())
        .await;
...
#[tokio::test]
async fn test_acceptance_closed_document_removed_from_completions() {
    ...
    state
        .open_document(uri_editor.clone(), "Link: [[".to_string())
        .await;
    state
        .open_document(uri_keep.clone(), "# Keep\n".to_string())
        .await;
    state
        .open_document(uri_close.clone(), "# Close Me\n".to_string())
        .await;
