...
// Original: src/md/parser.zig at commit 6a8f33e7b1 (bun-v1.3.9)
...
pub const Parser = struct {
    ...
    mark_char_map: std.StaticBitSet(256) = std.StaticBitSet(256).initEmpty(),
    ...
    // Recursion depth guard replacing Bun's StackCheck.
    // 128 matches md4c's default nesting limit.
